...
class MCTS(object):
    ...
    def _evaluate_rollout(self, state, limit):
        ...
        player wins and -1 if the opponent wins. (No tie case: get_winner_color() always
        returns BLACK or WHITE, and with the default half-integer komi an exact score tie
